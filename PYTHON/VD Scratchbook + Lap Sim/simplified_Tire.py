...
P_Dy3 = 0.006  #Variation of friction Muy with camber
...
P_Hy3 =0.000   #Variation of shift Shy with inclination
P_Vy1 =0.1 #Vertical shift in Svy/Fz at Fznom
P_Vy2 =-0.001143 #Variation of shift Svy/Fz with load
P_Vy3 =-0.001143 #Variation of shift Svy/Fz with inclination
P_Vy4 =-0.001143 #Variation of shift Svy/Fz with inclination and load
...
def MF_lateral_function (slip_angle,load,camber,t_slip):
    ...
    global S_Vy 
    S_Vy = load*(P_Vy1+P_Vy2*d_FZ)*L_VY*+turn_slip
    global alpha_y 
    ...
    F_y=D_y*np.sin(C_y*np.arctan(B_y*alpha_y-E_y*(B_y*alpha_y-np.arctan(B_y*alpha_y))))
    return (F_y)
